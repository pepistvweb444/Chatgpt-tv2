...
class DeviceHubActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(TextView(this).apply { text = "Llamadas · SMS · notificaciones · control de apps · accesibilidad"; textSize = 15f; setTextColor(0xFFB8B8B8.toInt()); setPadding(0,8,0,20) })
